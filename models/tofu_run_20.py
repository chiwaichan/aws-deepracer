...
SHORT_STRAIGHT_SPEED_WEIGHT = 5
MEDIUM_STRAIGHT_SPEED_WEIGHT = SHORT_STRAIGHT_SPEED_WEIGHT * 2.5
LONG_STRAIGHT_SPEED_WEIGHT = MEDIUM_STRAIGHT_SPEED_WEIGHT * 2.5
...
def reward_function(params):
    ...
    track_direction_heading_diff = track_direction - heading
    track_direction_heading_diff = get_normalised_angle(track_direction_heading_diff)
    # diff for 2 waypoints ahead
    track_direction_heading_diff_ahead_1 = track_direction_ahead_1 - heading
    track_direction_heading_diff_ahead_1 = get_normalised_angle(track_direction_heading_diff_ahead_1)
    track_direction_heading_diff_ahead_2 = track_direction_ahead_2 - heading
    track_direction_heading_diff_ahead_2 = get_normalised_angle(track_direction_heading_diff_ahead_2)
    track_direction_heading_diff_ahead_3 = track_direction_ahead_3 - heading
    track_direction_heading_diff_ahead_3 = get_normalised_angle(track_direction_heading_diff_ahead_3)


    heading_on_left_of_track_direction = track_direction_heading_diff < 0.0
    
    track_direction_ahead_1_current_track_direction_diff = track_direction_ahead_1 - track_direction
    track_direction_ahead_2_current_track_direction_diff = track_direction_ahead_2 - track_direction
    track_direction_ahead_3_current_track_direction_diff = track_direction_ahead_3 - track_direction
    track_direction_ahead_1_current_track_direction_diff = get_normalised_angle(track_direction_ahead_1_current_track_direction_diff)
    track_direction_ahead_2_current_track_direction_diff = get_normalised_angle(track_direction_ahead_2_current_track_direction_diff)
    track_direction_ahead_3_current_track_direction_diff = get_normalised_angle(track_direction_ahead_3_current_track_direction_diff)
    track_direction_ahead_1_left_turn = track_direction_ahead_1_current_track_direction_diff < 0.0
    ...
    elif track_direction_heading_diff_abs <= 3.0:
        sub_reward_direction_diff = 0.9
    elif track_direction_heading_diff_abs <= 5.0:
        sub_reward_direction_diff = 0.8
    elif track_direction_heading_diff_abs <= 15.0:
        sub_reward_direction_diff = 0.5
    elif track_direction_heading_diff_abs <= 25.0:
        sub_reward_direction_diff = 0.2
    elif track_direction_heading_diff_abs <= 35.0:
    ...
    sub_reward_track_position = 0.0
    sub_reward_steering = 0.0
    sub_reward_speed_heading = 0.0

    track_position_weight = 10.0
    steering_weight = 15.0
    speed_heading_weight = 50.0

    # turning left ahead
    if track_direction_ahead_1_left_turn:
        sub_reward_speed_heading = 0.0

        if track_direction_heading_diff > 90.0:
            sub_reward_speed_heading = -1.0
        elif track_direction_heading_diff > 60.0:
            sub_reward_speed_heading = -0.9
        elif track_direction_heading_diff > 30.0:
            sub_reward_speed_heading = -0.7
        elif track_direction_heading_diff > 15.0:
            sub_reward_speed_heading = -0.4
        elif track_direction_heading_diff > 10.0:
            sub_reward_speed_heading = -0.2

        if sub_reward_speed_heading != 0.0:
            if is_left_of_center:
                sub_reward_speed_heading *= 1.2

            sub_reward_speed_heading = sub_reward_speed_heading * max_speed_percentage / 100.0
        ...
        if is_right_of_center:
            if not all_wheels_on_track:
                sub_reward_track_position = -0.9

                if steering_angle < -15.0:
                    sub_reward_steering = -1.0
                if steering_angle < -10.0:
                    sub_reward_steering = -0.1
                elif steering_angle < -1.0:
                    sub_reward_steering = -0.1
                elif steering_angle <= 0.0:
                    sub_reward_steering = 0.0
                # steering too far left
                # steering correction liked and over steering prefered
                elif steering_angle > track_direction_heading_diff:
                    sub_reward_steering = 1.0
                else:
                    sub_reward_steering = 0.7
            elif percentage_within_of_center > 95:
                sub_reward_track_position = -0.4 

                if steering_angle < -15.0:
                    sub_reward_steering = -0.9
                if steering_angle < -10.0:
                    sub_reward_steering = -0.05
                elif steering_angle < -1.0:
                    sub_reward_steering = -0.01
                elif steering_angle <= 0.0:
                    sub_reward_steering = 0.0
                # steering too far left
                elif steering_angle > track_direction_heading_diff:
                    sub_reward_steering = 0.6
                else:
                    sub_reward_steering = 0.9
            elif percentage_within_of_center > 80:
                sub_reward_track_position = -0.2 
                ...
                sub_reward_track_position = 0.7 

                if steering_angle < -15.0:
                    sub_reward_steering = -0.3
                if steering_angle < -10.0:
                    sub_reward_steering = -0.02
                elif steering_angle < -1.0:
                    sub_reward_steering = -0.01
                ...
                if steering_angle < -15.0:
                    sub_reward_steering = -0.4
                if steering_angle < -10.0:
                    sub_reward_steering = -0.03
                elif steering_angle < -1.0:
                    sub_reward_steering = -0.01
            elif percentage_within_of_center <= 60.0:
                sub_reward_track_position = 1.0 

                if steering_angle < -15.0:
                    sub_reward_steering = -0.5
                if steering_angle < -10.0:
                    sub_reward_steering = -0.04
                elif steering_angle < -1.0:
                    sub_reward_steering = -0.01
            ...
            if not all_wheels_on_track:
                ...
                if steering_angle < -10.0:
                    ...
                    sub_reward_steering = 0.2
                elif steering_angle <= 0.0:
                    sub_reward_steering = 0.1
            elif percentage_within_of_center > 95:
                sub_reward_track_position = -0.5 
                ...
                sub_reward_track_position = -0.3 

                if steering_angle < -15.0:
                    sub_reward_steering = 0.8
                if steering_angle < -10.0:
                    sub_reward_steering = 0.3
                elif steering_angle < -1.0:
                    sub_reward_steering = -0.05
            elif percentage_within_of_center <= 40.0:
                sub_reward_track_position = 0.6 

                if steering_angle < -15.0:
                    sub_reward_steering = 0.4
            elif percentage_within_of_center <= 50.0:
                sub_reward_track_position = 0.8 

                if steering_angle < -15.0:
                    sub_reward_steering = 0.5
                if steering_angle < -10.0:
                    sub_reward_steering = 0.15
            elif percentage_within_of_center <= 60.0:
                sub_reward_track_position = 0.9 
    ...
    sub_rewards.append(sub_reward_track_position * track_position_weight)
    sub_rewards.append(sub_reward_steering * steering_weight)
    sub_rewards.append(sub_reward_speed_heading * speed_heading_weight)





    steering_angle_direction_heading_diff = track_direction_heading_diff - steering_angle
    steering_angle_direction_heading_diff = get_normalised_angle(steering_angle_direction_heading_diff)

    sub_reward_steering_angle_direction_heading_diff = 0.0

    # heading too far left
    if heading_on_left_of_track_direction:
        if steering_angle > 15.0:
            sub_reward_steering_angle_direction_heading_diff = -2.0
        if steering_angle > 10.0:
            sub_reward_steering_angle_direction_heading_diff = -1.5
        elif steering_angle > 1.0:
            sub_reward_steering_angle_direction_heading_diff = -1.0
        elif steering_angle >= 0.0:
            sub_reward_steering_angle_direction_heading_diff = -0.1
        # steering too far right
        elif steering_angle < track_direction_heading_diff:
            sub_reward_steering_angle_direction_heading_diff = 0.1
        else:
    ...
    # do speed and how close to center as compound
    sub_rewards.append(sub_reward_steering_angle_direction_heading_diff * STEERING_ANGLE_DIRECTION_HEADING_DIFF_WEIGHT)
    ...
    # long straight
    long_straight_speed_angle_count = get_count_of_waypoints_ahead_within_angle(waypoints, waypoints_len, next_point, 8)

    sub_reward_long_straight_speed = 0.0

    if long_straight_speed_angle_count >= 5:
        if max_speed_percentage < 25:
            sub_reward_long_straight_speed = -1.0
        elif max_speed_percentage < 50:
            sub_reward_long_straight_speed = 0.0
        elif max_speed_percentage < 70:
            sub_reward_long_straight_speed = 0.5
        elif max_speed_percentage < 80:
            sub_reward_long_straight_speed = 0.7
        else:
            sub_reward_long_straight_speed = 1.0

        sub_rewards.append(sub_reward_long_straight_speed * LONG_STRAIGHT_SPEED_WEIGHT * long_straight_speed_angle_count)

    # medium straight
    medium_straight_speed_angle_count = get_count_of_waypoints_ahead_within_angle(waypoints, waypoints_len, next_point, 6)

    sub_reward_medium_straight_speed = 0.0

    if medium_straight_speed_angle_count >= 4:
        if max_speed_percentage < 25:
            sub_reward_medium_straight_speed = -1.0
        elif max_speed_percentage < 50:
            sub_reward_medium_straight_speed = 0.0
        elif max_speed_percentage < 70:
            sub_reward_medium_straight_speed = 0.5
        elif max_speed_percentage < 80:
            sub_reward_medium_straight_speed = 0.7
        else:
            sub_reward_medium_straight_speed = 1.0

        sub_rewards.append(sub_reward_medium_straight_speed * MEDIUM_STRAIGHT_SPEED_WEIGHT * medium_straight_speed_angle_count)
    

    # short straight
    short_straight_speed_angle_count = get_count_of_waypoints_ahead_within_angle(waypoints, waypoints_len, next_point, 4)

    sub_reward_short_straight_speed = 0.0

    if short_straight_speed_angle_count >= 4:
        if max_speed_percentage < 25:
            sub_reward_short_straight_speed = -1.0
        elif max_speed_percentage < 50:
            sub_reward_short_straight_speed = 0.0
        elif max_speed_percentage < 70:
            sub_reward_short_straight_speed = 0.5
        elif max_speed_percentage < 80:
            sub_reward_short_straight_speed = 0.7
        else:
            sub_reward_short_straight_speed = 1.0

        sub_rewards.append(sub_reward_short_straight_speed * SHORT_STRAIGHT_SPEED_WEIGHT * short_straight_speed_angle_count)
    ...
    track_direction_heading_diff_ahead_1_abs = abs(track_direction_heading_diff_ahead_1)
    track_direction_heading_diff_ahead_2_abs = abs(track_direction_heading_diff_ahead_2)
    track_direction_heading_diff_ahead_3_abs = abs(track_direction_heading_diff_ahead_3)

    sub_reward_long_distance_ahead_heading = 0.0

    # Is the long distance ahead straight
    if track_direction_heading_diff_ahead_3_abs < 6.0:
    ...
    elif track_direction_heading_diff_ahead_3_abs < 10.0:
        if max_speed_percentage > 90.0:
    ...
    if track_direction_heading_diff_ahead_1_abs < 5.0:
        if percentage_within_of_center < 25.0:
            ...
            sub_reward_short_distance_ahead_center = -1.0
    elif track_direction_heading_diff_ahead_1_abs < 10.0:
        if percentage_within_of_center < 25.0:
    ...
    elif track_direction_heading_diff_ahead_1_abs >= 15.0:
        if percentage_within_of_center < 25.0:
    ...
    elif track_direction_heading_diff_ahead_1_abs >= 20.0:
        if percentage_within_of_center < 25.0:
    ...
    elif track_direction_heading_diff_ahead_1_abs >= 25.0:
        if percentage_within_of_center < 25.0:
            # sub_reward_short_distance_ahead_center = 0.4
            sub_reward_short_distance_ahead_center = 0.0
        elif percentage_within_of_center < 50.0:
    ...
    elif track_direction_heading_diff_ahead_1_abs >= 30.0:
        if percentage_within_of_center < 25.0:
            # sub_reward_short_distance_ahead_center = 0.3
            sub_reward_short_distance_ahead_center = 0.0
        elif percentage_within_of_center < 50.0:
    ...
    if track_direction_heading_diff_ahead_3_abs < 5.0:
    ...
    elif track_direction_heading_diff_ahead_3_abs >= 20.0:
        if percentage_within_of_center < 30.0:
            sub_reward_long_distance_ahead_center = 0.0
        elif percentage_within_of_center < 50.0:
            sub_reward_long_distance_ahead_center = 0.0
    ...
    elif track_direction_heading_diff_ahead_3_abs >= 30.0:
        if percentage_within_of_center < 30.0:
            sub_reward_long_distance_ahead_center = 0.0
        elif percentage_within_of_center < 50.0:
            sub_reward_long_distance_ahead_center = 0.0
    ...
    #         is_right_of_center,
    #         heading,
    #         heading_on_left_of_track_direction,
    #         track_direction,
    #         track_direction_heading_diff,
    #         track_direction_ahead_1,
    #         track_direction_heading_diff_ahead_1,
    #         track_direction_ahead_1_current_track_direction_diff,
    #         track_direction_ahead_1_left_turn,
    #         track_direction_ahead_2,
    #         track_direction_heading_diff_ahead_2,
    #         track_direction_ahead_2_current_track_direction_diff,
    #         track_direction_ahead_2_left_turn,
    #         track_direction_ahead_3,
    #         track_direction_heading_diff_ahead_3,
    #         track_direction_ahead_3_current_track_direction_diff,
    #         track_direction_ahead_3_left_turn,

    #         WAYPOINTS_PER_AHEAD_INTERVAL,
    #         METERS_PER_WAYPOINT,
    #         MAX_SPEED,
    #         DIRECTION_DIFF_WEIGHT,
    #         LONG_DISTANCE_AHEAD_HEADING_WEIGHT,
    #         IS_OFFTRACK_WEIGHT,
    #         ALL_WHEELS_ON_TRACK_WEIGHT,
    #         IS_REVERSED_WEIGHT,
    #         STEERING_ANGLE_DIRECTION_HEADING_DIFF_WEIGHT,
    #         SHORT_DISTANCE_AHEAD_STEERING_ANGLE_WEIGHT,
    #         SHORT_DISTANCE_AHEAD_CENTER_WEIGHT,
    #         MEDIUM_DISTANCE_AHEAD_STEERING_ANGLE_WEIGHT,
    #         MEDIUM_DISTANCE_AHEAD_CENTER_WEIGHT,
    #         LONG_DISTANCE_AHEAD_STEERING_ANGLE_WEIGHT,
    #         LONG_DISTANCE_AHEAD_CENTER_WEIGHT,

    #         SHORT_STRAIGHT_SPEED_WEIGHT,
    #         MEDIUM_STRAIGHT_SPEED_WEIGHT,
    #         LONG_STRAIGHT_SPEED_WEIGHT
    # ]

    # print("TOFU_RUN_LOG:" + ','.join([str(element) for element in vs]))
...
def get_count_of_waypoints_ahead_within_angle(waypoints, waypoints_len, from_point_idx, angle=5.0):
    count = 0

    track_direction = get_track_direction(waypoints, waypoints_len, from_point_idx)

    while (abs(track_direction - get_track_direction(waypoints, waypoints_len, from_point_idx, from_point_idx + count)) <= angle):
        count += 1

    # print(from_point_idx, count)
    return count
...
def test2():
    ...
    for waypoint in range(waypoints_len):
        get_count_of_waypoints_ahead_within_angle(waypoints, waypoints_len, waypoint)
