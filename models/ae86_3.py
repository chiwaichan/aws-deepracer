...
def reward_function(params):
    ...
    sub_reward_steering_angle_track_direction_heading_diff = 0.0

    if track_direction_heading_diff_abs < 6:
        if steering_angle_track_direction_heading_diff_abs < 2:
            sub_reward_steering_angle_track_direction_heading_diff = 1.0
        elif steering_angle_track_direction_heading_diff_abs < 10:
            sub_reward_steering_angle_track_direction_heading_diff = 1 / steering_angle_track_direction_heading_diff_abs


    sub_rewards.append(sub_reward_steering_angle_track_direction_heading_diff * STEERING_ANGLE_TRACK_DIRECTION_HEADING_WEIGHT)
    ...
    vs = [
            ...
            sub_reward_steering_angle_track_direction_heading_diff,
