...
def reward_function(params):
    ...
    steering_weight = 10.0
    speed_heading_weight = 10.0
    ...
    sub_rewards.append(sub_reward_long_distance_ahead_center * long_distance_ahead_center_weight_nested)       
            ...
            #     print("")
            #     print("track_direction", track_direction, "heading", heading, "track_direction_heading_diff", track_direction_heading_diff, "heading_on_left_of_track_direction", heading_on_left_of_track_direction)
